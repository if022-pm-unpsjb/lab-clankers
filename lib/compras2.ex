...
defmodule Libremarket.Compras.Server do
  ...
  def verificarInfraccion(pid \\ @global_name, datos),
    do: GenServer.call(pid, {:verificarInfraccion, datos})
...
# ============== HANLDE CALL ===================
  ...
  @impl true
  def handle_call({:verificarInfraccion, id_compra}, _from, state) do
    case Map.fetch(state.compras, id_compra) do
      {:ok, {status, compra}} ->
        case Libremarket.Infracciones.Server.verificarInfraccion(id_compra) do
          true ->
