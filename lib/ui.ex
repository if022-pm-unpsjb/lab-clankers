defmodule Libremarket.Ui do
  ...
  def comprar(id_producto, medio_de_pago, forma_de_entrega) do
    ...
    if(confirma_compra) do
      Libremarket.Compras.Server.comprar({id_producto, medio_de_pago, forma_de_entrega}) # Libremarket.Compras.Server.comprar({id_producto, medio_de_pago, forma_de_entrega})
    end
  end
